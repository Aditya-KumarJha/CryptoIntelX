export default function Footer() {
  return (
    <footer className="py-8 border-t text-center text-sm">
      <p>© {new Date().getFullYear()} CryptoIntelX. All rights reserved.</p>

      <div className="flex flex-wrap justify-center gap-6 mt-4">
        <a href="https://github.com/Aditya-KumarJha/CryptoIntelX" target="_blank" rel="noopener noreferrer" className="transition">GitHub</a>
