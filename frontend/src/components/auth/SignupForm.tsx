...
export default function SignupForm({ setOtpStep, setUserEmail }: Props) {
  ...
  return (
    <div className="bg-white/80 dark:bg-black/80 backdrop-blur-md p-10 flex flex-col justify-center text-gray-900 dark:text-white rounded-r-2xl">
      <h2 className="text-2xl font-bold text-center mb-2">Create Your CryptoIntelX Account</h2>
      <p className="text-sm text-gray-600 dark:text-gray-300 text-center mb-6">
        Join CryptoIntelX to monitor crypto threats, analyze blockchain activity, and track suspicious wallets securely.
      </p>
      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div>
            ...
            />
            {errors.lastName && (
              <p className="text-red-500 text-xs mt-1">Please enter your last name</p>
            )}
          </div>
        </div>
        ...
        <div>
          ...
          />
          {errors.email && <p className="text-red-500 text-xs mt-1">Please enter your email</p>}
        </div>
        ...
        <p className="text-center text-sm text-gray-600 dark:text-gray-400 mt-4">
          ...
          <Link href="/login" className="text-teal-500 dark:text-cyan-400 hover:underline">
            Login
          </Link>
        </p>
      </form>
